...
// NurseTrack One: editor demográfico del expediente, cargado solo en v4-beta.
try{
 if(/\/v4-beta\//i.test(NT_PATH)&&!window.__NT_V4_PATIENT_EDITOR_LOADER__){
  window.__NT_V4_PATIENT_EDITOR_LOADER__=true;
  const s=document.createElement('script');
  s.src='patient-editor.js?v=20260910-edit-record-1';
  s.defer=true;
  (document.head||document.documentElement).appendChild(s);
 }
}catch(_){}
